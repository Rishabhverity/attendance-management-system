...
Generated for HR Leave & Attendance Management System
"""
...
# For development, using SQLite (no setup required)
# In production (Render), DATABASE_URL env var is automatically set
DATABASES = {
